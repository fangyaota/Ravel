    ...
    public sealed class NeoBinder
    {
        ...
        private BoundExpression BindExpression(ExpressionSyntax syntax)
        {
            return syntax switch
            {
                ...
                DotExpressionSyntax dot => BindDotExpression(dot),
        ...
        private BoundExpression BindLambdaDefining(LambdaDefiningExpressionSyntax lambda)
        {
            ...
            RavelType ty = Global.TypePool.FunctionTypeOf(ret, types);
        ...
        private BoundExpression BindFunctionDefiningExpression(FunctionDefiningExpressionSyntax defining)
        {
            ...
            if (defining.TypeIdentifier != null)
            {
                ...
                RavelType type = Global.TypePool.FunctionTypeOf(o, parameters.Select(x => x.Type).ToArray());
        ...
        r:
            ...
            RavelType ty = Global.TypePool.FunctionTypeOf(sentence.Type, parameters.Select(x => x.Type).ToArray());
            return new BoundFunctionDefiningExpression(parameters, sentence, ty);
        }

        private BoundExpression BindDotExpression(DotExpressionSyntax dot)
        {
            ...
            return new BoundDotExpression(left, dot.Right.Text, Global.TypePool.VoidType);//?
        }
